...
def generate_dataset(source_path, target_path):
    ...
    train_images = sorted(os.listdir(os.path.join('data', 'prepared_dataset', 'train')))
    ...
    val_images = sorted(os.listdir(os.path.join('data', 'prepared_dataset', 'validation')))
    ...
    test_images = sorted(os.listdir(os.path.join('data', 'prepared_dataset', 'test')))
...
if __name__ == '__main__':
    ...
    dest_path = os.path.join('data', 'prepared_dataset_2048')
